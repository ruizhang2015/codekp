...
public class SVNUtil {
	 ...
	 * 氓炉鹿盲潞沤盲陆驴莽鈥澛╤ttp://氓鈥櫯抙ttps茂录鈥�7// DAVRepositoryFactory.setup(); //
	 * 氓炉鹿盲潞沤盲陆驴莽鈥澛╯vn茂录鈥�7/ /氓鈥櫯抯vn+xxx茂录鈥�7/ /
	 * SVNRepositoryFactoryImpl.setup(); // 氓炉鹿盲潞沤盲陆驴莽鈥澛╢ile://
	 * FSRepositoryFactory.setup(); }
	 * 
	 * public boolean login() { setupLibrary(); try { // 氓藛鈥好ヂ宦好ヂ衡�溍颗久ε解��7
	 * repository =
	 * SVNRepositoryFactoryImpl.create(SVNURL.parseURIEncoded(this.svnRoot)); //
	 * 猫潞芦盲禄陆茅陋艗猫炉锟� ISVNAuthenticationManager authManager =
	...
	/*
	 * public void filterCommitHistoryTest() throws Exception { // 猫驴鈥∶β宦っ︼拷隆盲禄露
	 ...
	 * 盲赂潞猫驴鈥∶β宦っ♀�灻︹�撯�∶ぢ宦睹仿ヂ锯�灻モ�帮拷莽录鈧寂捗ぢ嘎好┞好÷ぢ好ぢ革拷猫驴鈥好∨捗库�∶β宦�
